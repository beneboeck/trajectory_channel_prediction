...
imag_data = h5py.File('../Simulations/trajectory_channel_prediction/data/H_imag_Uma_mixed_IO_600_200.mat', 'r')
real_data = h5py.File('../Simulations/trajectory_channel_prediction/data/H_real_Uma_mixed_IO_600_200.mat', 'r')
...
np.save('../Simulations/trajectory_channel_prediction/data/H_train_Uma_mixed_IO_600_200',H_train)
np.save('../Simulations/trajectory_channel_prediction/data/H_test_Uma_mixed_IO_600_200',H_test)
np.save('../Simulations/trajectory_channel_prediction/data/H_val_Uma_mixed_IO_600_200',H_val)
