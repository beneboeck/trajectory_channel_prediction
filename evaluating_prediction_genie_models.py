...
NMSE_DFT_Tra = ev.channel_prediction(setup,model_DFT_Tra,dataloader_test,10,dir_path,device,'testing')
...
setup = [LD,memory,rnn_bool,en_layer,en_width,pr_layer,pr_width,de_layer,de_width,cov_type,BN,prepro]
NMSE_TN_Tra = ev.channel_prediction(setup,model_TN_Tra,dataloader_test,10,dir_path,device,'testing')
...
setup = [LD,memory,rnn_bool,en_layer,en_width,pr_layer,pr_width,de_layer,de_width,cov_type,BN,prepro]
NMSE_TD_Tra = ev.channel_prediction(setup,model_TD_Tra,dataloader_test,10,dir_path,device,'testing')

NMSE_keep_last = ev.keep_last(dataloader_test,10,device)

print(NMSE_DFT_Tra)
print(NMSE_TN_Tra)
print(NMSE_TD_Tra)
print(NMSE_keep_last)