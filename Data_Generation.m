...
H_real = real(H);
H_imag = imag(H);
H_real_train = H_real(1:4000,:,:);
H_real_val = H_real(4001:4500,:,:);
H_real_test = H_real(4501:end,:,:);
H_imag_train = H_imag(1:4000,:,:);
H_imag_val = H_imag(4001:4500,:,:);
H_imag_test = H_imag(4501:end,:,:);
path_gains_train = path_gains(1:4000,:);
path_gains_val = path_gains(4001:4500,:);
path_gains_test = path_gains(4501:end,:);
