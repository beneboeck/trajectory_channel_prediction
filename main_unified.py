...
if not(exists(overall_path + MODEL_TYPE + '_' + '20dB_noise_NAS_file.txt')):
    csvfile = open(overall_path + MODEL_TYPE + '_' + '20dB_noise_NAS_file.txt','w')
...
csv_file = open(overall_path + MODEL_TYPE + '_' + '20dB_noise_NAS_file.txt','a')
